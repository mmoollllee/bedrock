...
/* harmony import */ var _jquery_fancybox__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./jquery.fancybox */ "./src/js/jquery.fancybox.js");
/* harmony import */ var _swiper__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./swiper */ "./src/js/swiper.js");
...
$(function () {
  ...
  (0,_jquery_fancybox__WEBPACK_IMPORTED_MODULE_5__.default)();
});
...
var noOfMasonryItems = 12;

function macyReinit(instance) {
  instance.reInit();
  setTimeout(function () {
    macyReinit(instance);
  }, 1000);
...
function toggle(els, display, fancybox) {
  els.forEach(function (el) {
    el.style.display = display;

    if (fancybox) {
      el.setAttribute('data-fancybox', fancybox);
    }
  });
}

function filterByClass(els, className) {
  className = className.length ? className : 'grid-item';
  return Array.from(els).filter(function (el) {
    return el.classList.contains(className);
  });
}

function masonryFilters(el, instance) {
  jQuery('[data-filter]').on('click', function (event) {
    event.preventDefault();
    var dataAttr = this.getAttribute('data-filter');
    var gridItemEls = el.querySelectorAll('.grid-item');
    el.setAttribute('data-count', '0');

    if (this.classList.contains("active")) {
      // Style Filter-Button inactive
      this.classList.remove("active");
      toggle(gridItemEls, '', 'gallery'); // Reinit Masonry

      instance.reInit();
    } else {
      var activeFilterEl = document.querySelector('.filters .active') || false; // Style Filter-Button active

      if (activeFilterEl) {
        activeFilterEl.classList.remove("active");
      }

      this.classList.add("active"); // Hide all

      toggle(gridItemEls, 'none'); // Show first 12 & enable Fancybox

      var elsToShow = filterByClass(gridItemEls, dataAttr).slice(0, noOfMasonryItems);
      toggle(elsToShow, 'block', dataAttr); // Add current filter-name to el

      el.setAttribute('data-filter-active', dataAttr); // Reinit Masonry

      instance.reInit();
    }

    moreButton(el, instance);
  });
}

function moreButton(masonryEl, macyInstance) {
  var moreButtonEl = document.querySelector('#more');

  if (!moreButtonEl) {
    return;
  }

  var currentFilter = masonryEl.getAttribute('data-filter-active') || false;
  var currentCount = parseInt(masonryEl.getAttribute('data-count')) || noOfMasonryItems;
  var filteredItemEls = filterByClass(masonryEl.querySelectorAll('.grid-item'), currentFilter);

  if (filteredItemEls.length < currentCount) {
    moreButtonEl.style.display = 'none';
    return;
  }

  moreButtonEl.style.display = 'block';
  jQuery(moreButtonEl).off('click').on('click', function (e) {
    console.log('click');
    e.preventDefault();
    var currentFilter = masonryEl.getAttribute('data-filter-active') || false;
    var currentCount = parseInt(masonryEl.getAttribute('data-count')) || noOfMasonryItems;
    var filteredItemEls = filterByClass(masonryEl.querySelectorAll('.grid-item'), currentFilter);
    var nextCount = currentCount + noOfMasonryItems;
    filteredItemEls = filteredItemEls.slice(0, nextCount);
    masonryEl.setAttribute('data-count', nextCount);
    toggle(filteredItemEls, 'block');
    moreButton(masonryEl, macyInstance);
    macyReinit(macyInstance);
  });
}

function fireMacy(masonryEl, options) {
  if (!masonryEl) {
    return;
  }

  var macyInstance = macy__WEBPACK_IMPORTED_MODULE_0___default()(options);
  setTimeout(function () {
    macyReinit(macyInstance);
  }, 1000);
  masonryFilters(masonryEl, macyInstance);
  moreButton(masonryEl, macyInstance);
}

/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  var selector = document.querySelector('.masonry');
  var options = {
    container: selector,
    mobileFirst: true,
    columns: 2,
  ...
  fireMacy(selector, options);
  selector = document.querySelector('.masonry-2');
  options = {
    container: selector,
    mobileFirst: true,
    columns: 2,
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  ...
  jQuery('body,html').on('scroll mousedown DOMMouseScroll mousewheel keyup', function (e) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
  jQuery('[data-fancybox], a[href$=".jpg"], a[href$=".jpeg"], a[href$=".png"], a[href$=".gif"]').off('click').fancybox({
    afterShow: function afterShow(instance, current) {
      var swiper = current.opts['$orig'].closest('.swiper-container');

      if (swiper.length > 0) {
        swiper.get(0).swiper.slideTo(current.index);
      }
    },
...
/* harmony export */   "default": () => (/* export default binding */ __WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var jquery_on_screen__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery-on-screen */ "./node_modules/jquery-on-screen/index.js");
/* harmony import */ var jquery_on_screen__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery_on_screen__WEBPACK_IMPORTED_MODULE_0__);


function scrollto(target) {
  var position = jQuery(target).offset(); //position = jQuery("[name='"+target.split("#")[1]+"']").offset();
...
/***/ "./src/js/jquery.menu-touch-hover.js":
/*!*******************************************!*\
  !*** ./src/js/jquery.menu-touch-hover.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
  ...
  jQuery('#responsivemenu a, #navclose, #responsivemenu button').on('click', function () {
    closeSlideout();
  });
});
...
var swipers = [];
var selector = '.slider-horizontal .swiper-container';
var sliderHorizontalEls = document.querySelectorAll(selector);

if (sliderHorizontalEls.length) {
  sliderHorizontalEls.forEach(function (el) {
    el.insertAdjacentHTML('beforebegin', '<button class="swiper-button-next"></button><button class="swiper-button-prev"></button>');
    swipers['slider-horizontal'] = new swiper_core__WEBPACK_IMPORTED_MODULE_0__.default(el, {
      navigation: {
  ...
  setTimeout(function () {
    swipers['slider-horizontal'].init();
  }, 1000);
}
...
$('.whatever').click(function () {
    ...
    if (loop) {
      ...
      swipers['video'].on('init slideChange', function (swiper) {
        ...
        if (swiper.slides[current].classList.contains('is-video')) {
          console.log('play');
          video = swiper.slides[current].getElementsByTagName("video")[0];
          video.play();
  ...
  if ($(selector).length) {
    ...
    swipers['header-grid'] = new swiper_core__WEBPACK_IMPORTED_MODULE_0__.default(selector, {
      navigation: {
        nextEl: '.swiper-button-next',
        prevEl: '.swiper-button-prev'
      },
  ...
  if ($(selector).length) {
    ...
    swipers['gallery'] = new swiper_core__WEBPACK_IMPORTED_MODULE_0__.default(selector, {
      navigation: {
        nextEl: '.swiper-button-next',
        prevEl: '.swiper-button-prev'
      },
  ...
  if ($(selector).length) {
    ...
    swipers['category'] = new swiper_core__WEBPACK_IMPORTED_MODULE_0__.default(selector, {
      navigation: {
        nextEl: '.swiper-button-next',
        prevEl: '.swiper-button-prev'
      },
...
/***/ "./builder/scss/builder-restrict.scss":
/*!********************************************!*\
  !*** ./builder/scss/builder-restrict.scss ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 	__webpack_require__.O(undefined, ["main","editor","builder-restrict","builder","backend"], () => (__webpack_require__("./src/js/app.js")))
/******/ 	__webpack_require__.O(undefined, ["main","editor","builder-restrict","builder","backend"], () => (__webpack_require__("./src/scss/main.scss")))
/******/ 	__webpack_require__.O(undefined, ["main","editor","builder-restrict","builder","backend"], () => (__webpack_require__("./src/scss/editor.scss")))
/******/ 	__webpack_require__.O(undefined, ["main","editor","builder-restrict","builder","backend"], () => (__webpack_require__("./src/scss/backend.scss")))
/******/ 	__webpack_require__.O(undefined, ["main","editor","builder-restrict","builder","backend"], () => (__webpack_require__("./builder/scss/builder.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["main","editor","builder-restrict","builder","backend"], () => (__webpack_require__("./builder/scss/builder-restrict.scss")))
